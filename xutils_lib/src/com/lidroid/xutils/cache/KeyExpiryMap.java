...
public class KeyExpiryMap<K, V> extends ConcurrentHashMap<K, Long> {
	...
	public synchronized boolean containsKey(Object key) {
		...
		/*
		 * if (super.containsKey(key)) { Long expiryTimestamp = super.get(key);
		 * if (expiryTimestamp != null && System.currentTimeMillis() <
		 * expiryTimestamp) { result = true; } else { this.remove(key); }
		 */
